...
whole_tre_unmodified = tree_loading.build_and_annotate_tree(dates, phylogeny_nodes, taxa, descr_years, tree_filename="mammals_dna.tre", has_branch_lengths=True)
