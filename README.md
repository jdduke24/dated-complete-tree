...
For example:
 ...
 will produce 10 trees with different topologies, and output a text file with phylogenetic diversity (PD) distributions for the clades specified in your text file `./pd_clades.txt` (one Open Tree node name per line, e.g. Eukaryota_ott304358).
